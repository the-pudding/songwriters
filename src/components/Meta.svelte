<script>
	export let title = "Women are superstars on stage, but still rarely get to write songs";
	export let description = "Songwriting credits since 1958, broken down by gender";
	export let url = "https://pudding.cool/2023/07/songwriters";
	export let keywords = "songwriting,music,gender,music";
